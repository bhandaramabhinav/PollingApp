(function () {
    ...
    function EditGroupController($scope, $http, $location, $mdDialog, $routeParams, $localStorage, $sessionStorage, $window) {
        ...
        $scope.LoadGroups=function()
        {
            ...
            $scope.GetGroupsStatus = $http.get('api/Groups/GetGroupsByCreatedUserId/?userId=' + $scope.userId)
           ...
           ,function error(response) {
            ...
            $scope.GetUsersStatus = $http.get('api/User/GetUsers')
            .then(function success(response) {
        ...
        $scope.UpdateGroup = function ($event) {
            ...
            $scope.CreateGroupStatus = $http.post('api/Groups/PostDeleteAddUsersInGroup', deleteUserGroupList).then(function success(response) {
